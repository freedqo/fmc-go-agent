...
import (
	"github.com/freedqo/fmc-go-agent/internal/fmc-go-agent-server/dal/db/dbif/{{.DbName}}_if/{{.TableName}}_if"
...
import (
	"github.com/freedqo/fmc-go-agent/internal/fmc-go-agent-server/dal/db/dbif/{{.DbName}}_if"
  	{{- range $tb := .Tbs}}
  	"github.com/freedqo/fmc-go-agent/internal/fmc-go-agent-server/dal/db/dbif/{{$tb.DbName}}_if/{{$tb.TableName}}_if"
	"github.com/freedqo/fmc-go-agent/internal/fmc-go-agent-server/dal/db/gdb/{{$tb.DbName}}_gdb/{{$tb.TableName}}_gdb"
    {{- end}}
	"github.com/freedqo/fmc-go-agent/internal/fmc-go-agent-server/model/dalm/dbm/{{.DbName}}/model"
	"github.com/freedqo/fmc-go-agent/internal/fmc-go-agent-server/model/dalm/dbm/{{.DbName}}/query"
...
func New(opt *ugrom.Option) {{.DbName}}_if.If {
...
import (
	...
	"github.com/freedqo/fmc-go-agent/internal/fmc-go-agent-server/dal/db/gdb/{{$db.DbName}}_gdb"
	{{- end}}
    "github.com/freedqo/fmc-go-agent/pkg/ugrom"
)
