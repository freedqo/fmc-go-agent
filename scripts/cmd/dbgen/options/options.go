...
var ModelRootPath = "./internal/fmc-go-agents-server/model/dalm/dbm" // 数据库模型根路径
var DbIfRootPath = "./internal/fmc-go-agents-server/dal/db/dbif"     // 数据库接口根路径
var DbGdbRootPath = "./internal/fmc-go-agents-server/dal/db/gdb"     // 数据库接口Gdb实现根路径
var DbUdbRootPath = "./internal/fmc-go-agents-server/dal/db/udb"     // 数据库接口Gdb实现根路径
